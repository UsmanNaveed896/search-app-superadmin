        ...
        <div className={`flex h-screen ${drawerOpen ? 'overflow-y-scroll' : ''}`}>
          ...
          >
            <div className=" px-6 pb-3 pt-5 bg-[#f6faff] ">
              ...
              <ul>
              <Link to="/">
                  <li className={`cursor-pointer  ${selectedLink === 'dashboard' ? 'font-bold' : ''} ${selectedLink === 'dashboard' ? 'text-[#295DFA]' : 'text-[#94AEFF]'}  mb-4`}
                ...
                <Link to="/user">
                  <li className={`cursor-pointer ${selectedLink === 'profile' ? 'font-bold' : ''} ${selectedLink === 'profile' ? 'text-[#295DFA]' : 'text-[#94AEFF]'}  mb-4`}
                  onClick={()=>handlePageSwitch("profile")}
                  >
                    <i class={`fa fa-user mr-3 ${selectedLink === 'profile' ? 'text-[#295DFA]' : 'text-[#94AEFF]'} text-[16px]`} aria-hidden="true"></i> User
                  </li>
                </Link>
              
                <Link to="/addnews">
                  <li className={`cursor-pointer  ${selectedLink === 'addnews' ? 'font-bold' : ''} ${selectedLink === 'addnews' ? 'text-[#295DFA]' : 'text-[#94AEFF]'}  mb-4`}
                ...
                <Link to="/topnews">
                  <li className={`cursor-pointer  ${selectedLink === 'topnews' ? 'font-bold' : ''} ${selectedLink === 'topnews' ? 'text-[#295DFA]' : 'text-[#94AEFF]'}  mb-4`}
                ...
                <Link to="/chats">
                <li  className={`cursor-pointer  ${selectedLink === 'messages' ? 'font-bold' : ''} ${selectedLink === 'messages' ? 'text-[#295DFA]' : 'text-[#94AEFF]'}  mb-4`}
                ...
                <Link to="/schedules">
                <li className={`cursor-pointer  ${selectedLink === 'schedules' ? 'font-bold' : ''} ${selectedLink === 'schedules' ? 'text-[#295DFA]' : 'text-[#94AEFF]'}  mb-4`}
                ...
                <li className={`cursor-pointer  ${selectedLink === 'subscription' ? 'font-bold' : ''} ${selectedLink === 'subscription' ? 'text-[#295DFA]' : 'text-[#94AEFF]'}  mb-4`}
                ...
                <li className={`cursor-pointer  ${selectedLink === 'virtualoffice' ? 'font-bold' : ''} ${selectedLink === 'virtualoffice' ? 'text-[#295DFA]' : 'text-[#94AEFF]'}  mb-4`}
                ...
                <li className={`cursor-pointer  ${selectedLink === 'verificationrequest' ? 'font-bold' : ''} ${selectedLink === 'verificationrequest' ? 'text-[#295DFA]' : 'text-[#94AEFF]'}  mb-4`}
                ...
                <Link to="/meetings">
                <li className={`cursor-pointer  ${selectedLink === 'meetings' ? 'font-bold' : ''} ${selectedLink === 'meetings' ? 'text-[#295DFA]' : 'text-[#94AEFF]'}  mb-4`}
          ...
          <div className={`flex-1 ${drawerOpen ? 'ml-64' : ''} transition-all duration-300`}>
            ...
            <div className="p-1">
              ...
              <Routes>
                ...
                <Route exact path='/verificationrequest' element={<VerificationReq/>} />
